classdef CameraPovrayScriptWriter < CurveFileWriter
    ...
    methods (Access = public)
        function this = CameraPovrayScriptWriter(camera)
            this.camera = camera;
            name = camera.getName();
            this.filename = strcat(name, 'Cam.pov');
        end
